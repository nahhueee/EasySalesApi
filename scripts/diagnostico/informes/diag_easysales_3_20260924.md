...
|---|---|---|---|---|
| backups | InnoDB | utf8mb4_0900_ai_ci | 5 | 16.0 KB |
| cajas | InnoDB | utf8mb4_0900_ai_ci | 84 | 16.0 KB |
| cajas_movimientos | InnoDB | utf8mb4_0900_ai_ci | 30 | 80.0 KB |
| cargos | InnoDB | utf8mb4_0900_ai_ci | 3 | 16.0 KB |
| categorias | InnoDB | utf8mb4_0900_ai_ci | 3 | 16.0 KB |
| clientes | InnoDB | utf8mb4_0900_ai_ci | 54 | 32.0 KB |
| cuenta_corriente_movimientos | InnoDB | utf8mb4_0900_ai_ci | 235 | 64.0 KB |
...
| listas_precio | InnoDB | utf8mb4_0900_ai_ci | 2 | 16.0 KB |
...
| parametros_impresion | InnoDB | utf8mb4_0900_ai_ci | 2 | 16.0 KB |
| presupuestos | InnoDB | utf8mb4_0900_ai_ci | 0 | 48.0 KB |
| presupuestos_detalle | InnoDB | utf8mb4_0900_ai_ci | 0 | 32.0 KB |
| producto_precio_historial | InnoDB | utf8mb4_0900_ai_ci | 889 | 160.0 KB |
| productos | InnoDB | utf8mb4_0900_ai_ci | 1529 | 224.0 KB |
| productos_precios | InnoDB | utf8mb4_0900_ai_ci | 1529 | 240.0 KB |
...
| usuarios | InnoDB | utf8mb4_0900_ai_ci | 3 | 16.0 KB |
| usuarios_movimientos | InnoDB | utf8mb4_0900_ai_ci | 3485 | 272.0 KB |
| ventas | InnoDB | utf8mb4_0900_ai_ci | 4991 | 400.0 KB |
| ventas_detalle | InnoDB | utf8mb4_0900_ai_ci | 15230 | 1.8 MB |
| ventas_entrega | InnoDB | utf8mb4_0900_ai_ci | 34 | 32.0 KB |
| ventas_entrega_detalle | InnoDB | utf8mb4_0900_ai_ci | 121 | 16.0 KB |
| ventas_factura | InnoDB | utf8mb4_0900_ai_ci | 83 | 16.0 KB |
...
Primera migration aplicada: `20260319122219_add_campos_tipos_pago.js` (Mon May 11 2026 18:18:31 GMT-0300 (hora estándar de Argentina)) — aproxima la antigüedad de la instalación.
...
- **HALLAZGO:** 6 fila(s) huérfana(s) (columna identificadora: `id`). Ejemplos: 1067, 1126, 2479, 3241, 3874, 3914 (VARIOS = id 1)
...
- NULL: 54 · = 0: 0 · huérfanos: 0

### `ventas.idLista` -> `listas_precio.id`
- NULL: 1352 · = 0: 0 · huérfanos: 0
...
Cajas finalizadas analizadas: 78
- dan 0 de diferencia: 64
- dan distinto de 0: 14
- suma absoluta de diferencias: 67384.65

| Año | Suma absoluta de diferencias |
|---|---|
| 2026 | 67384.65 |

- **HALLAZGO:** 14 caja(s) finalizada(s) con `cajas.ventas` distinto de la suma de `ventas.total`. No se define ni corrige acá qué debería ir en cajas.ventas (decisión de negocio, 3.4).

## C10. Stock

Estado: **HALLAZGO**

Productos activos: 1522
Con cantidad < 0: 514
- **HALLAZGO:** 514 producto(s) activo(s) con cantidad negativa.
Con cantidad decimal en unidad distinta de KG: 9
- **HALLAZGO:** 9 producto(s) con cantidad decimal fuera de unidad KG.
