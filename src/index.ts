...
import presupuestosRuta from './routes/presupuestosRoute';
import listasRuta from './routes/listasRoute';
...
app.use('/easysales/presupuestos', presupuestosRuta);
app.use('/easysales/listas', listasRuta);
